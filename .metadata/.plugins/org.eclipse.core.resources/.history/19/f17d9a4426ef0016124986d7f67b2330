...
public class Numero implements Serializable {
	...
	//bi-directional many-to-one association to ConcursoLotoFacil
	@OneToMany(mappedBy="numero")
	private List<ConcursoLotoFacil> concursoLotoFacils;
	...
	public List<ConcursoLotoFacil> getConcursoLotoFacils() {
		return this.concursoLotoFacils;
	}

	public void setConcursoLotoFacils(List<ConcursoLotoFacil> concursoLotoFacils) {
		this.concursoLotoFacils = concursoLotoFacils;
	}

	public ConcursoLotoFacil addConcursoLotoFacil(ConcursoLotoFacil concursoLotoFacil) {
		getConcursoLotoFacils().add(concursoLotoFacil);
		concursoLotoFacil.setNumero(this);

		return concursoLotoFacil;
	}

	public ConcursoLotoFacil removeConcursoLotoFacil(ConcursoLotoFacil concursoLotoFacil) {
		getConcursoLotoFacils().remove(concursoLotoFacil);
		concursoLotoFacil.setNumero(null);
