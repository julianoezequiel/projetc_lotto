...
public class ConcursoMegaSena implements Serializable {
	...
	private BigDecimal estimativa_Prêmio;
	...
	public BigDecimal getEstimativa_Prêmio() {
		return this.estimativa_Prêmio;
	}

	public void setEstimativa_Prêmio(BigDecimal estimativa_Prêmio) {
		this.estimativa_Prêmio = estimativa_Prêmio;
	}
