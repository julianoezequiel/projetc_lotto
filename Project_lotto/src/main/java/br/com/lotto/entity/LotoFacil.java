...
public class LotoFacil implements Serializable {
    ...
    @NotNull
    @Column(name = "idConcurso_Loto_Facil")
    private Integer idConcursoLotoFacil;
    ...
    @Column(name = "Ganhadores_15_Numeros")
    ...
    @Column(name = "UF")
    private String uf;
    @Column(name = "Ganhadores_14_Numeros")
    private Integer ganhadores14Numeros;
    @Column(name = "Ganhadores_13_Numeros")
    private Integer ganhadores13Numeros;
    @Column(name = "Ganhadores_12_Numeros")
    private Integer ganhadores12Numeros;
    @Column(name = "Ganhadores_11_Numeros")
    private Integer ganhadores11Numeros;
    @Column(name = "Valor_Rateio_15_Numeros")
    private BigDecimal valorRateio15Numeros;
    @Column(name = "Valor_Rateio_14_Numeros")
    private BigDecimal valorRateio14Numeros;
    @Column(name = "Valor_Rateio_13_Numeros")
    private BigDecimal valorRateio13Numeros;
    @Column(name = "Valor_Rateio_12_Numeros")
    private BigDecimal valorRateio12Numeros;
    @Column(name = "Valor_Rateio_11_Numeros")
    private BigDecimal valorRateio11Numeros;
    @Column(name = "Acumulado_15_Numeros")
    ...
    public LotoFacil(Integer idConcursoLotoFacil) {
        this.idConcursoLotoFacil = idConcursoLotoFacil;
    }

    public Integer getIdConcursoLotoFacil() {
        return idConcursoLotoFacil;
    }

    public void setIdConcursoLotoFacil(Integer idConcursoLotoFacil) {
        this.idConcursoLotoFacil = idConcursoLotoFacil;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (idConcursoLotoFacil != null ? idConcursoLotoFacil.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if ((this.idConcursoLotoFacil == null && other.idConcursoLotoFacil != null) || (this.idConcursoLotoFacil != null && !this.idConcursoLotoFacil.equals(other.idConcursoLotoFacil))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "br.com.lotto.entity.ConcursoLotoFacil[ idConcursoLotoFacil=" + idConcursoLotoFacil + " ]";
    }
